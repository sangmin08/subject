...
-- 데이터베이스: `202604_com08`
--
CREATE DATABASE IF NOT EXISTS `202604_com08` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `202604_com08`;
...
CREATE TABLE `book_checkouts` (
  ...
  `chekout_data` varchar(100) NOT NULL,
...
INSERT INTO `modals` (`id`, `title`, `content`, `image`, `start_date`, `end_date`) VALUES
(9, '32', '32', '스크린샷 2026-03-07 163732.png', '2026-03-01', '2026-03-18');

-- --------------------------------------------------------

--
-- 테이블 구조 `room_reservations`
--
...
INSERT INTO `user` (`id`, `account_id`, `name`, `password`) VALUES
(1, '', '안상민', '1234'),
(2, '', '안상민', '1234'),
(3, 'sangmin', '안상민', '1234'),
(4, 'sangmin', '안상민', '1234');
...
--
-- 테이블의 AUTO_INCREMENT `book_checkouts`
--
ALTER TABLE `book_checkouts`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- 테이블의 AUTO_INCREMENT `modals`
--
ALTER TABLE `modals`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- 테이블의 AUTO_INCREMENT `room_reservations`
--
ALTER TABLE `room_reservations`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
('root', '[{\"db\":\"202604_com08\",\"table\":\"modals\"},{\"db\":\"202604_com08\",\"table\":\"user\"},{\"db\":\"202604_com08\",\"table\":\"room_reservations\"},{\"db\":\"202604_com08\",\"table\":\"books\"},{\"db\":\"202604_com08\",\"table\":\"book_checkouts\"}]');
...
('root', '2026-03-07 07:56:05', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"ko\"}');
