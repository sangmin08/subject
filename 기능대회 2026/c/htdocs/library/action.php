...
switch ($mode) {
    case "checkin":
        ...
        if ($book_id == '') {
            echo "<script>alert('잘못된 접근입니다.'); location.href='/library/dataroom.php';</script>";
            exit;
        }
        ...
        if ($check) {
            echo "<script>alert('이미 대출중인 도서입니다.'); location.href='/library/dataroom.php';</script>";
            exit;
        }
        ...
        echo "<script>alert('대출이 완료되었습니다.'); location.href='/library/dataroom.php';</script>";
        exit;
        break;
